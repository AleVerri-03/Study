...
#include <deal.II/fe/fe_q.h> // Cambiato da fe_simplex_p.h a fe_q.h per 1D standard
 ...
 * (Keeping the name Poisson2D as requested, although it solves a 1D ADR problem)
 */
class Poisson2D
{
public:
  // Physical dimension set to 1D for Exercise 3
