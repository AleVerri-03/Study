...
Stokes::assemble()
{
...

  {
    ...
    {
      std::map<types::global_dof_index, double> boundary_values_2;
      ...
      boundary_values.insert(boundary_values_2.begin(), boundary_values_2.end());
    }
    
    {
      std::map<types::global_dof_index, double> boundary_values_3;
      VectorTools::interpolate_boundary_values(
        dof_handler,
        3,
        Functions::ZeroFunction<dim>(dim + 1),
        boundary_values_3,
        ComponentMask(std::vector<bool>{true, true, false}));
      boundary_values.insert(boundary_values_3.begin(), boundary_values_3.end());
    }
